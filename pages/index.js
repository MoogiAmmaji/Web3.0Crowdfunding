...
export default function Index({AllData, HealthData, EducationData,AnimalData,StartupsData}) {
  ...
  return (
    <HomeWrapper>
      ...
      <FilterWrapper>
        ...
        <Category onClick={() => setFilter(StartupsData)}>Startups</Category>
      </FilterWrapper>
        ...
        return (
          ...
          <CardImg>
            <Image 
              ...
              layout='fill' 
              src={"https://ammaji.infura-ipfs.io/ipfs/" + e.image} 
            />
          </CardImg>
          <Title>
            {e.title}
...
export async function getStaticProps() {
  ...
  const getStartupsCampaigns = contract.filters.campaignCreated(null,null,null,null,null,null,'Startups');
  const StartupsCampaigns = await contract.queryFilter(getStartupsCampaigns);
  const StartupsData = StartupsCampaigns.map((e) => {
    return {
      title: e.args.title,
      image: e.args.imgURI,
      owner: e.args.owner,
